...
# RUG-CIT=16
    ...
    cmdstring="curl -u somerandomstring -T "+csv_file+" https://surfdrive.surf.nl/files/public.php/webdav/Compute/"+str(last_year)+"/"+last_month_text+ "-"+str(last_year)+"_ey_"+os.path.basename(csv_file)
